...
const heroes = [
  {
    name: 'Batman',
    biography: { fullName: 'Bruce Wayne', placeOfBirth: 'Gotham City', alignment: 'good' },
    powerstats: { intelligence: 81, strength: 40, speed: 29, durability: 55, power: 63, combat: 90 },
    appearance: { race: 'Human', gender: 'Male', height: ["6'2", '188 cm'], weight: ['210 lb', '95 kg'] },
  },
  {
    name: 'Ant-Man',
    biography: { fullName: 'Scott Lang', placeOfBirth: 'Coral Gables, Florida', alignment: 'good' },
    powerstats: { intelligence: 63, strength: 28, speed: 35, durability: 28, power: 71, combat: 55 },
    appearance: { race: 'Human', gender: 'Male', height: ["6'0", '183 cm'], weight: ['190 lb', '86 kg'] },
  },
  {
    name: 'Zoom',
    biography: { fullName: '-', placeOfBirth: '-', alignment: 'bad' },
    powerstats: { intelligence: 50, strength: 10, speed: 100, durability: 60, power: 55, combat: 45 },
    appearance: { race: null, gender: 'Male', height: ["6'1", '185 cm'], weight: ['195 lb', '88 kg'] },
  },
]
...
describe('sortHeroes - missing values', () => {
  const withMissing = [
    ...
    { ...heroes[2], appearance: { ...heroes[2].appearance, race: 'Metahuman' } },
  ]
